...
function CreateTableForIndex(parent, json) {
    ...
    for (let i = 0; i < json.length; i++) {
        ...
        a1.addEventListener("click", function() {
            setCookie('idNewsFor', json[i].newsId, { 'max-age': 3600, samesite: 'strict' });
        ...
        td1.innerText = json[i].newsId;
        td2.innerText = json[i].heading;
